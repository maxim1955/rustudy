<template>
  <div class="modal_material">
    ...
    <div class="modal_material_tab">
      <div class="fg">
        <p class="modal_tab__title" :class="{modal_material_tab__active: statusCreated === 'info' }">Информация</p>
      </div>
      <div class="fg">
        ...
        <div class="modal_form_select">
          <div class="form_select__level">
            <div class="form_check_level pb ">
              <p class="modal_label pb">Выберите для какого уровня владения языка предназначен материал</p>
              <div class="">
